...
task = st.sidebar.text_area("Пациент из AI'Doctor",
                         "Предсатвь себе что ты доктор."
                         "У тебя есть пациент по которому есть следующая информация."
                         "Информация, жалобы и результаты исследования пациента:",
                     height = 240)
